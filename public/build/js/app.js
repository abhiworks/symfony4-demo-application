...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  for (i = 0; i < sessionStorage.length; i++) {
    ...
    //console.log( sessionStorage.key(i), $(" option[value="+sessionStorage.getItem(sessionStorage.key(i))+" ]").attr('data-color') );
    if ($(" option[value=" + sessionStorage.getItem(sessionStorage.key(i)) + " ]").attr('data-color') != '') {
